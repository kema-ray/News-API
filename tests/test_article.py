...
class TestArticle(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.articles_object.author,'Jay Peters')
        self.assertEqual(self.articles_object.description,'Block and Blockstream are partnering with Tesla on an open-source, solar-powered Bitcoin mine, the companies announced Friday. Teslas 3.8-megawatt Solar PV array and its 12 megawatt-hour Megapack will power the facility, and construction has started on the p…')
        self.assertEqual(self.articles_object.content,'Its set to open later this year\r\nIf you buy something from a Verge link, Vox Media may earn a commission. See our ethics statement.\r\nIllustration by Alex Castro / The Verge\r\nBlock and Blockstream, a … [+1336 chars]')
        self.assertEqual(self.articles_object.publishedAt,'2022-04-29T13:15:44Z')
